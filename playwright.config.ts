...
const config: PlaywrightTestConfig = {
    ...
    use: { // for browser specific options
        ...
        video: "retain-on-failure", //this is for the video recording of the test, if it's on, the test will be recorded, if it's off, the test will not be recorded, if it's retain-on-failure, the test will be recorded only if it fails
        screenshot: "only-on-failure", //this is for the screenshots of the test, if it's on, the screenshots will be taken, if it's off, the screenshots will not be taken
    }, 
