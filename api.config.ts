...
const config: PlaywrightTestConfig = {
    ...
    use: { // for browser specific options
        ...
        viewport: { width: 1280, height: 720 }, //this is for the size of the browser window, it's in pixels
        actionTimeout:10000, // timeout for all playout functions like click and fill
        ...
        video: "off", //this is for the video recording of the test, if it's on, the test will be recorded, if it's off, the test will not be recorded, if it's retain-on-failure, the test will be recorded only if it fails
